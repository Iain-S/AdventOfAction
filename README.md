...
If you and your friends/colleagues share a repo for [Advent of Code](https://adventofcode.com), you can use this to run your solutions to each day's problems.
